...
class AlumnoLista(APIView):
    ...
    def get(self, request, format=None):
        queryset = Alumno.objects.filter(erase=False)
...
class AlumnoDetalles(APIView):
    ...
    def get_object(self, id):
        try:
            return Alumno.objects.get(pk=id, erase=False)
...
class CarreraLista(APIView):
    permission_classes = (IsAuthenticated,)    
    def get(self, request, format=None):
        queryset = Carrera.objects.filter(erase=False)
...
class CarreraDetalles(APIView):
    ...
    def get_object(self, id):
        try:
            return Carrera.objects.get(pk=id, erase=False)
